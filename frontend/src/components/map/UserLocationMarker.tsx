  ...
  useEffect(() => {
    ...
    const init = async () => {
      ...
      const icon = L.divIcon({
        html: `
          <div class="user-location-marker" style="width: 40px;pointer-events: none; height: 40px; position: relative; display: flex; align-items: center; justify-content: center;">
