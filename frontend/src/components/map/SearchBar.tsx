    ...
    <div className="relative w-full max-w-2xl mx-auto flex gap-2">
      <div className="relative flex-1">
        <input
          ...
          className="w-full px-3 pl-11 py-2.5 md:py-3 md:px-4 md:pl-12 md:text-lg text-md   rounded-full bg-white/80 backdrop-blur-[5px] [-webkit-backdrop-filter:blur(5px)] dark:bg-zinc-900 text-zinc-900 dark:text-zinc-100 focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent shadow-sm transition-colors"
        />
