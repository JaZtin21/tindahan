...
export function PostPreviewModal({ post, isOpen, onClose, onEdit, onDelete }: PostPreviewModalProps & { onEdit?: (post: Post) => void; onDelete?: (post: Post) => void }) {
  ...
  // Mobile Bottom Sheet Variant (90% full screen from bottom)
  if (isMobile) {
    return (
      <div className="fixed inset-0 z-50">
        ...
        {/* Bottom Sheet Content - 90% height */}
        <div
          className="absolute left-0 right-0 bottom-0 bg-white dark:bg-zinc-900 rounded-t-2xl shadow-2xl w-full h-[90vh] flex flex-col animate-in slide-in-from-bottom duration-300"
        ...
        >
          ...
          {/* Author Header - Same layout as desktop */}
          <div className="px-4 py-3 pb-2 border-b border-zinc-100 dark:border-zinc-800">
            <div className="flex items-center gap-3">
              ...
              {/* Action buttons - both on the right side (SAME AS DESKTOP) */}
              {isCurrentUser && (
              ...
              {/* Close Button - on the far right (SAME AS DESKTOP) */}
              <button
                onClick={onClose}
          ...
          <div className="flex-1 overflow-y-auto">
            ...
            {/* Comments Section */}
            <div className="border-t border-zinc-100 dark:border-zinc-800 flex flex-col" style={{ maxHeight: '350px' }}>
  ...
  // Desktop: Centered Modal (variables already declared above)
  return (
    <div 
